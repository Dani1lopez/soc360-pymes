...
os.environ.setdefault("DATABASE_URL", "postgresql+asyncpg://soc360_app:***REMOVED***@localhost:5433/soc360_test")
os.environ.setdefault("DATABASE_URL_MIGRATION", "postgresql+asyncpg://soc360_migration:***REMOVED***@localhost:5433/soc360_test")
